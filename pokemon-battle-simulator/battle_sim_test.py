...
{'name':'mewtwo','stats':{'health':12,'attack':16,'defense':9,'speed':13,'type1':'psychic','type2':'none'},
 'moves':[{'name':'psychic','power':21,'type':'psychic'},{'name':'hyper beam','power':24,'type':'normal'},{'name':'shadow ball','power':21,'type':'ghost'},{'name':'poison jab','power':21,'type':'poison'}],},
{'name':'charizard','stats':{'health':11,'attack':15,'defense':11,'speed':13,'type1':'fire','type2':'flying'},
 'moves':[{'name':'fire blast','power':21,'type':'fire'},{'name':'slash','power':24,'type':'normal'},{'name':'dragon claw','power':21,'type':'dragon'},{'name':'hurricane','power':21,'type':'flying'}],},
{'name':'venusaur','stats':{'health':12,'attack':13,'defense':14,'speed':11,'type1':'grass','type2':'poison'},
 'moves':[{'name':'solar beam','power':21,'type':'grass'},{'name':'sludge bomb','power':21,'type':'poison'},{'name':'take down','power':24,'type':'normal'},{'name':'earthquake','power':21,'type':'ground'}],},
{'name':'blastoise','stats':{'health':11,'attack':13,'defense':15,'speed':11,'type1':'water','type2':'none'},
 'moves':[{'name':'hydro pump','power':21,'type':'water'},{'name':'skull bash','power':24,'type':'normal'},{'name':'blizzard','power':21,'type':'ice'},{'name':'flash cannon','power':21,'type':'steel'}],},
{'name':'eevee','stats':{'health':12,'attack':11,'defense':14,'speed':13,'type1':'normal','type2':'none'},
 'moves':[{'name':'swift','power':24,'type':'normal'},{'name':'quick attack','power':18,'type':'normal'},{'name':'bite','power':21,'type':'dark'},{'name':'iron tail','power':21,'type':'steel'}],},
{'name':'onyx','stats':{'health':8,'attack':8,'defense':24,'speed':10,'type1':'rock','type2':'ground'},
 'moves':[{'name':'stone edge','power':21,'type':'rock'},{'name':'earthquake','power':21,'type':'ground'},{'name':'dragon breath','power':21,'type':'dragon'},{'name':'slam','power':24,'type':'normal'}],},
{'name':'alakazam','stats':{'health':7,'attack':17,'defense':11,'speed':15,'type1':'psychic','type2':'none'},
 'moves':[{'name':'psychic','power':21,'type':'psychic'},{'name':'seismic toss','power':21,'type':'fighting'},{'name':'thunder punch','power':21,'type':'electric'},{'name':'ice punch','power':21,'type':'ice'}],},
{'name':'gengar','stats':{'health':8,'attack':18,'defense':10,'speed':14,'type1':'ghost','type2':'poison'},
 'moves':[{'name':'shadow ball','power':21,'type':'ghost'},{'name':'sucker punch','power':15,'type':'dark'},{'name':'thunder','power':21,'type':'electric'},{'name':'dream eater','power':21,'type':'psychic'}],},
{'name':'nidoqueen','stats':{'health':14,'attack':13,'defense':12,'speed':11,'type1':'ground','type2':'poison'},
 'moves':[{'name':'earthquake','power':21,'type':'ground'},{'name':'super power','power':21,'type':'fighting'},{'name':'poison jab','power':21,'type':'poison'},{'name':'dragon tail','power':21,'type':'dragon'}],},
{'name':'machamp','stats':{'health':13,'attack':18,'defense':12,'speed':7,'type1':'electric','type2':'none'},
 ...
 'moves':[{'name':'cross chop','power':21,'type':'fighting'},{'name':'dual chop','power':21,'type':'dragon'},{'name':'payback','power':21,'type':'dark'},{'name':'heavy slam','power':21,'type':'steel'}],},
 {'name':'scizor','stats':{'health':11,'attack':17,'defense':14,'speed':8,'type1':'bug','type2':'steel'},
 'moves':[{'name':'fury cutter','power':21,'type':'bug'},{'name':'bullet punch','power':15,'type':'steel'},{'name':'vacuum wave','power':15,'type':'fighting'},{'name':'night slash','power':21,'type':'dark'}],},
 {'name':'snorlax','stats':{'health':19,'attack':13,'defense':13,'speed':5,'type1':'normal','type2':'none'},
 'moves':[{'name':'body slam','power':24,'type':'normal'},{'name':'psychic','power':21,'type':'psychic'},{'name':'fire blast','power':21,'type':'fire'},{'name':'surf','power':21,'type':'water'}],},
 {'name':'dragonite','stats':{'health':13,'attack':16,'defense':12,'speed':9,'type1':'dragon','type2':'flying'},
 'moves':[{'name':'dragon rage','power':21,'type':'dragon'},{'name':'aqua jet','power':15,'type':'water'},{'name':'wing attack','power':21,'type':'flying'},{'name':'fire punch','power':21,'type':'fire'}],},
 {'name':'dewgong','stats':{'health':13,'attack':11,'defense':14,'speed':12,'type1':'water','type2':'ice'},
 'moves':[{'name':'aurora beam','power':21,'type':'ice'},{'name':'megahorn','power':21,'type':'bug'},{'name':'aqua jet','power':15,'type':'water'},{'name':'drill run','power':21,'type':'ground'}],},
]
